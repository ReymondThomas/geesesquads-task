...
<Link to={'/add'}>
    <Button variant="success"><i class="fa-solid fa-user-plus"></i>Add Task</Button> 
    </Link>
    </div>
    ...
    <Table className='w-75 container border text-center' striped bordered hover variant="white">
      <thead>
